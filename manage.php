...
if (isset($_POST["submit"])){ 
  ...
  if (add_admin($username,$password,$type,$nic)) {
             echo '<script type="text/javascript">';
             echo 'setTimeout(function () { swal.fire({title:"Success!",text: "Admin added successfully!",type: "success",showConfirmButton: false });';
             echo '}, 1000);</script>';
            }else {
             echo '<script type="text/javascript">';
             echo 'setTimeout(function () { swal.fire({title:"Error!",text: "Admin adding failed!",type: "error",showConfirmButton: false });';
             echo '}, 1000);</script>';
...
function add_admin($uname,$psw,$a_type,$a_nic) {     
      $con=mysqli_connect("localhost","root","","emarketlk");
      $query = "INSERT INTO admin(admin_uname,admin_pw,admin_type,admin_nic) VALUES ('$uname','$psw','$a_type','$a_nic')";
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="manage.php">Add Admins</a></li>
				...
				<div class="col-sm-offset-1">
					<div class="col-sm-6">
						...
						<form action="#" form method="post" >
							Admin Username:<input type="text" name="a_uname" placeholder="Admin Username"/>
							Admin Password: <input type="password" name="password" placeholder="Admin Password"/>
							Type: <select name="type">
								  <option value="manager">Manager</option>
								  <option value="admin">Admin</option>
							</select>
						    Admin NIC: <input type="text" name="nic" placeholder="NIC"/>
