...
$con=new mysqli('localhost','root','','emarketlk');
echo $con->connect_error;
	$sql = "SELECT item, sum(amount) FROM product group by item";
     $result = $con->query($sql);

	?>
<html>
  <head>
  //basic libary loading
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
//difine chart to be drawn
        var data = google.visualization.arrayToDataTable([
          ['name', 'qty'],
          <?php
		  while ($row=$result->fetch_assoc())
		  {
    echo "['".$row['item']."',".$row['sum(amount)']."],";
          } 
		  ?>
        ]);
