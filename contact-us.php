...
$mail->setFrom('emarketlkshop@gmail.com', 'Contact me form');
...
if(!$mail->send()) {
             ...
             echo 'setTimeout(function () { swal.fire({title:"Error!",text: "Error in contacting us!",type: "error",showConfirmButton: false });';
             echo '}, 1000);</script>';
    echo 'Mailer Error: ' . $mail->ErrorInfo;
} else {
            echo '<script type="text/javascript">';
             echo 'setTimeout(function () { swal.fire({title:"Success!",text: "Thanks for contacting us! We will be in touch with you shortly",type: "success",showConfirmButton: false });';
             echo '}, 1000);</script>';
	    	...
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					...
					<div id="gmap" class="contact-map">
						<img src="images/contactus/contact-us-banner.jpg" height="400" width="1200">
					</div>
				</div>			 		
			</div>    	
    		<div class="row">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>E-Market Inc.</p>
							<p>923/7 Rahula Junction, Rahula Rd, Matara</p>
							<p>Sri Lanka</p>
							<p>Mobile: +94710401417</p>
							<p>Fax: 041132452</p>
							<p>Email: info@emarketlk.com</p>
	    				</address>
