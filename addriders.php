...
if (isset($_POST["submit"])){ 
    ...
    $city =$_POST['city'];
if(is_valid_name($name) && is_valid_nic($nic)){

  if (add_rider($nic,$name,$address,$city)) {
             echo '<script type="text/javascript">';
             echo 'setTimeout(function () { swal.fire({title:"Success!",text: "Rider added successfully!",type: "success",showConfirmButton: false });';
             echo '}, 1000);</script>';
            }else {
             echo '<script type="text/javascript">';
             echo 'setTimeout(function () { swal.fire({title:"Error!",text: "Rider adding failed!",type: "error",showConfirmButton: false });';
             echo '}, 1000);</script>';
...
function add_rider($nic1,$name1,$address1,$city1) {     
      $con=mysqli_connect("localhost","root","","emarketlk");
      $query = "INSERT INTO rider(nic,name,address,city) VALUES ('$nic1','$name1','$address1','$city1')";
...
function is_valid_name($uname)
{        
     $con=mysqli_connect("localhost","root","","emarketlk");

     $slquery = "SELECT nic FROM rider WHERE name = '$uname'";
...
function is_valid_nic($id)
{        
     $con=mysqli_connect("localhost","root","","emarketlk");

     $slquery = "SELECT nic FROM rider WHERE nic = '$id'";
     $selectresult = mysqli_query ($con, $slquery);
     if(mysqli_num_rows($selectresult)>0){
             echo '<script type="text/javascript">';
...
<head>
    ...
    <title>Add riders | E-Market</title>
				...
				<div class="col-sm-offset-1">
					<div class="col-sm-6">
						...
						<form action="#" form method="post" >
							NIC: <input type="text" name="r_nic" placeholder="Rider NIC"/>
							Rider Name: <input type="text" name="name" placeholder="Rider name"/>
							...
							<button type="submit" name="submit" class="btn btn-default">Add Rider</button>
						</form>
					</div><!--/sign up form-->
				</div>
				</div>
